  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-indigo-500/10 to-blue-500/10 backdrop-blur-xl rounded-2xl border border-indigo-500/20 p-6"
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-1">Request History</h2>
            <p className="text-indigo-200">Complete history of all component requests</p>
          </div>
        </div>
      </motion.div>
